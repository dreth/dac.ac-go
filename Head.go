...
func Head(Title string, Description string, Article bool) *elem.Element {
	...
	headNodes = append(headNodes,
		...
		elem.Meta(attrs.Props{
			"property":    "og:image",
			attrs.Content: "/assets/icons/meta.png",
		}),
		...
		elem.Script(attrs.Props{
			attrs.Src: "/assets/js/libs/htmx.min.js",
		}),
	...
	if Article {
		...
		headNodes = append(headNodes,
			elem.Link(attrs.Props{
				attrs.Rel:  "stylesheet",
				attrs.Href: "/assets/css/libs/sunburst-prettify.css",
			}),
			elem.Script(attrs.Props{
				attrs.Src: "/assets/js/libs/prettify.js",
			}),
			// and latex related stuff too
			elem.Link(
				attrs.Props{
					attrs.Rel:         "stylesheet",
					attrs.Href:        "/assets/css/libs/katex.min.css",
			...
			elem.Script(
				attrs.Props{
					attrs.Defer:       "true",
					attrs.Src:         "/assets/js/libs/katex.min.js",
					attrs.Crossorigin: "anonymous",
				},
			),
			elem.Script(
				attrs.Props{
					attrs.Defer: "true",
					attrs.Src:   "/assets/js/katexRenderSingleDollarSign.js",
				},
			),
			elem.Script(
				attrs.Props{
					attrs.Defer: "true",
					attrs.Src:   "/assets/js/libs/auto-render.min.js",
