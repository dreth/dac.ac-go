...
\vspace{-1pt}
\resumeSubItem{Data}{~~~~~~~~~~~~~Manip./analysis/viz of data, ML models. Metabase. DB design, PostgreSQL, MySQL, MSSQL, ClickHouse.}
\vspace{-1pt}
\resumeSubItem{Tools}{~~~~~~~~~~~~~~Git, GH actions, docker/compose, Kubernetes, CI/CD, networking, linux servers cloud/on-premise.\\~~~~~~~~~~~~~~~~~~~~~~~~VanillaJS, HTMX, TailwindCSS, Django, DRF, FastAPI, Fiber-go, Gin, React, ORMs.\\~~~~~~~~~~~~~~~~~~~~~~~~Unix shells (zsh, bash, sh, etc.) y CLIs, SRE. Jira, Confluence. Spreadsheets/MS Office.}
\vspace{-1pt}
